...
function BGim = GetBgIm(fstk_src,fcness_src ,pixNumInSP,useSP)
% EstimateBgProb
...
for k=1:N
    ...
    % %      fcnesImg = (fcnesImg-miii)./(maaa-miii);%¶Á Data\focsdetmap\9__refocus_\9__refocus_00.png
...
blsinfo = Finfobls;
%    blsinfo(FGcandi)=0;
BGslc_num = find(blsinfo==max(blsinfo));
